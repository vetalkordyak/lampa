(function() {
    ...
    const menuItems = [
        ...
        { action: "hbo", title: "HBO", url: "discover/tv?language=ua&with_networks=49,1129,1590,2593,3186", component: "category_full", source: "tmdb", sort: "now", card_type: "true", page: 1 },
