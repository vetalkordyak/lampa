(function() {
    ...
    const menuItems = [
        { action: "hd", title: "В UHD якості", url: "?cat=&sort=now&uhd=true&language=ua", component: "category_full", source: "cub", sort: "now", card_type: "true", page: 1 },
        ...
        { action: "disney", title: "Disney+", url: "discover/tv?language=ua&with_networks=2739", component: "category_full", source: "tmdb", sort: "now", card_type: "true", page: 1 },
